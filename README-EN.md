...
```
cd existing_repo
git remote add origin https://git.ponycool.com/ponycool/nebula/nebula-lib.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.ponycool.com/ponycool/nebula/nebula-lib/-/settings/integrations)
